...
class Filter:
    ...
    df = pd.read_csv(project_dir + "/Code/recommenderapp/prediction_scripts/data/movies.csv")
    ratings = pd.read_csv(project_dir + "/Code/recommenderapp/prediction_scripts/data/ratings.csv")
